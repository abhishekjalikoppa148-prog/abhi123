...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-gradient-to-b from-blue-50 to-white dark:from-[#0A0A0F] dark:to-[#12121A] transition-colors duration-300">
      <div className="w-full max-w-md space-y-8 p-8 rounded-3xl bg-white dark:bg-[#12121A] border border-blue-200 dark:border-[#27272A] shadow-lg dark:shadow-blue-500/10 backdrop-blur-xl transition-colors duration-300">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Start creating unforgettable birthday surprises.</p>
        </div>
        ...
        <form onSubmit={handleSignupSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white dark:bg-[#1A1A24] border border-blue-200 dark:border-[#27272A] text-slate-900 dark:text-white text-sm focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-500/20 transition-colors"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full pl-10 pr-11 py-2.5 rounded-xl bg-white dark:bg-[#1A1A24] border border-blue-200 dark:border-[#27272A] text-slate-900 dark:text-white text-sm focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-500/20 transition-colors"
              />
              <button
                type="button"
          ...
          <label className="flex items-start gap-2 cursor-pointer text-xs text-slate-600 dark:text-slate-400">
            ...
            />
            <span>I agree to the <Link href="/terms" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold">Terms of Service</Link> and <Link href="/privacy" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold">Privacy Policy</Link></span>
          </label>
        ...
        <div className="text-center text-xs text-slate-600 dark:text-slate-400">
          ...
          <Link href="/login" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold">
            Sign In
          </Link>
        </div>
